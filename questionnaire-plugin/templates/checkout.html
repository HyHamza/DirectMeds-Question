...
<!--[if lt IE 9]><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"><![endif]-->    <meta charset="utf-8">
    ...
    <link href="../assets/css/bootstrap.min.css" rel="stylesheet"
         >
    <link href="./css/qualify-v2.css" rel="stylesheet">
    <link href="./css/chat.css" rel="stylesheet">
    <link rel="stylesheet" href="../assets/css/bootstrap-icons.min.css">
    <link rel="icon" type="image/png" href="../assets/images/favicon.png">
    <script src="https://cdn.jsdelivr.net/npm/@tsparticles/confetti@3.0.3/tsparticles.confetti.bundle.min.js"></script>
    <link type="text/css" rel="stylesheet" href="https://utils.webimghost.com/scripts/css/utils.min.css">
...
<script>
    ...
    _paq.push(["setDomains", ["*.direct-meds.com","*.app.direct-meds.com"]]);
                _paq.push(['setCustomDimension', 4, 'cid-68e274b834435bd3157026958b97bb21']);    _paq.push(["enableCrossDomainLinking"]);
...
<noscript><p><img referrerpolicy="no-referrer-when-downgrade" src="https://directmeds.matomo.cloud/matomo.php?idsite=1&amp;rec=1" style="border:0;" alt="" /></p></noscript><!-- Google Tag Manager -->
        ...
        window.dataLayer.push({
            ...
            'customer_id': 'cid-68e274b834435bd3157026958b97bb21',
            'last_touch_channel': '',
...
<form action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" id="ccForm">
    ...
    <input type="hidden" name="external_customer_id" value="cid-68e274b834435bd3157026958b97bb21"><input type="hidden" name="domain" value="directmeds.com"><input type="hidden" name="offer_slug" value="dm-offers"><input type="hidden" name="external_created_at" value="1759671480">    <input type="hidden" name="csrf_token" value="4a51cd73fed592c728c46016ac4fd34b0c75c3cea6d928c89aa203ca425cac869550699516" />
    <input type="hidden" name="telemed_data" value="1" />
    <input type="hidden" name="lb_checkout" value="1" />
    <!--    <input type="hidden" name="--><!--" value="" />-->
    <input type='hidden' name='lb_endpoint' value='portal-flows' /><input type='hidden' name='portal_checkout' value='1' />    <nav class="navbar navbar-expand-lg bannerbar">
        <div class="container justify-content-center">
            <img src="../assets/images/logo.png" alt="Direct Meds" class="img-fluid">
        </div>
    </nav>
                ...
                <div class="col-lg-8 offset-lg-2 col-md-12">
                    ...
                    <div class="row">
                        <div class="col stats-item inversebg offsetbg">
                            <div class="row">
                                <div class="col-4">
                                    <img src="../assets/images/select-product0.png" class="img-fluid">
                                </div>
                            ...
                            <hr>
                            <!--<div class="row">
                                <div class="col my-auto textalt2 text-end">
                                    Monthly supply shipped monthly <span style="font-size:12px;line-height:1;">(Cancel anytime)</span>                                </div>
                                <div class="col-4 my-auto  text-end" style="padding-right:25px;">
                                    <span class="was">$</span> $                                </div>
                            </div>
                            <hr>-->
                            <div class="row">
                            ...
                            <hr>
                                ...
                                <div class="col text-end" style="padding-right:25px;">
                                    <h4><b style="font-size:1.5rem;">$<span class="priceToday">0</span></b></h4>
                                </div>
                            </div>
                            ...
                            <div class="inversebg" style="border:1px solid #ccc;">
                                ...
                                <div class="pcinner">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col text-end">
                                            <img src="../assets/images/cards.png" style="width:150px;" class="img-fluid">
                                        </div>
                                    ...
                                    <br>
                                    <center><img src="../assets/images/securicons.png" class="img-fluid"></center>
                                    <br>
                                    <hr>
    ...
    <div class="footer-badge"><a href="https://www.legitscript.com/websites/?checker_keywords=directmeds.com" target="_blank" title="Verify LegitScript Approval for www.directmeds.com"><img src="../assets/images/183773.png" alt="Verify Approval for www.directmeds.com" width="73" height="79" /></a></div><div class="footer-badge" ><a href="https://cardinsight.com" target="_blank" ><img src="img/ci-badge.png" class="img-fluid d-block mx-auto" style="max-width:150px;margin-top:40px;"></a></div><script>
...
<script>
    ...
    window.cid = 'cid-68e274b834435bd3157026958b97bb21';
</script>
<script>
    ...
    smartlook('identify', 'cid-68e274b834435bd3157026958b97bb21', {
        "offer": "dm-offers",
        "click_id": "",
        "affiliate": "",
        "sub_affiliate": "",
...
<script type="text/javascript">
    ...
    var etSubmitData = {
        ...
        'everflow_offer_id': '',
        'offer_id': 'dm-offers',
        'external_customer_id': 'cid-68e274b834435bd3157026958b97bb21',
        'source_id': '',
        'everflow_uid': '',
        'page': 'checkout',
        'ip_address': '34.46.237.233',
    ...
    if (previousId == "") {
        ...
        EF.click({
            ...
            Adv1: 'cid-68e274b834435bd3157026958b97bb21',
...
<script src="https://script.securehost000.com/22ee4a40-49c3-427f-881d-cd7153ff9d90/checkout.js"></script>
</body>
</html>