...
<script>
    ...
    _paq.push(["setDomains", ["*.direct-meds.com","*.app.direct-meds.com"]]);
                _paq.push(['setCustomDimension', 4, 'cid-68e274a04aad16f17c54460a0db870e7']);    _paq.push(["enableCrossDomainLinking"]);
...
<noscript><p><img referrerpolicy="no-referrer-when-downgrade" src="https://directmeds.matomo.cloud/matomo.php?idsite=1&amp;rec=1" style="border:0;" alt="" /></p></noscript><!-- Google Tag Manager -->
        ...
        window.dataLayer.push({
            ...
            'customer_id': 'cid-68e274a04aad16f17c54460a0db870e7',
            'last_touch_channel': '',
            'offer_slug': 'dm-offers',
            'page': 'questionnaire-3'
        });
        </script>
...
<div id="couponBanner" style="position:fixed;top:0;z-index:100;width:100%;padding:5px 10px;background-color:#0094FF;color:#fff;text-align:center;font-weight:700;">A coupon has been applied to your order! Complete your order for up to $100 off your first month!</div></div><form id="questionnaireForm" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" >
    ...
    <center><div class="pre-card"><h5 style="color:#fff;">Semaglutide & Tirzepatide In Stock as low as $147</h5>
<p style="color:#969ecf; font-size:14px;"> Injection and Oral Sublingual options now available!</p></div></center>
    <div class="card step">
...
<script type="text/javascript">
    ...
    var etSubmitData = {
        ...
        'everflow_offer_id': '',
        'offer_id': 'dm-offers',
        'external_customer_id': 'cid-68e274a04aad16f17c54460a0db870e7',
        'source_id': '',
        'everflow_uid': '',
        'page': 'questionnaire-3',
        'ip_address': '34.46.237.233',
    ...
    if (previousId == "") {
        ...
        EF.click({
            ...
            Adv1: 'cid-68e274a04aad16f17c54460a0db870e7',
...
<script>
    ...
    document.getElementById('closeWarning').addEventListener('click',function(){
        ...
        let state = document.querySelector('[name="intake_state"]');
        removePulse(state);
        if(state.value == 'MS' || state.value == 'LA') {
            triggerBadResponseMessage();
        } else if(state.value != "")
            return true;
        addPulse(state);
...
<script>
    ...
    smartlook('identify', 'cid-68e274a04aad16f17c54460a0db870e7', {
        "offer": "dm-offers",
        "click_id": "",
        "affiliate": "",
        "sub_affiliate": "",
