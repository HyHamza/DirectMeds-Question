...
<script>
    ...
    _paq.push(["setDomains", ["*.theweightlossadvocates.com","*.app.theweightlossadvocates.com"]]);
                _paq.push(['setCustomDimension', 4, 'cid-68e274b73dfd93c6b1e1a904a109263a']);    _paq.push(["enableCrossDomainLinking"]);
...
<noscript><p><img referrerpolicy="no-referrer-when-downgrade" src="https://Weight Loss Advocates.matomo.cloud/matomo.php?idsite=1&amp;rec=1" style="border:0;" alt="" /></p></noscript><!-- Google Tag Manager -->
        ...
        window.dataLayer.push({
            ...
            'customer_id': 'cid-68e274b73dfd93c6b1e1a904a109263a',
            'last_touch_channel': '',
            'offer_slug': 'dm-offers',
            'page': 'WeightLossAdvocates-14'
        });
        </script>
...
<!-- End Google Tag Manager (noscript) --><form id="WeightLossAdvocatesForm" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" >
    ...
    <div class="card-body">
        ...
        <h1>What would be your perfect goal weight?</h1><br><br>
        <div class="row g-3 justify-content-center">
            <div class="col-auto">
                Your Goal Weight (lbs)
                <input type="tel" name="intake_goal_weight" class="form-control form-control-lg" value="" style="font-size:31px;font-weight:bold;text-align:center;border:4px solid #c8cdfa">
            </div>
...
<script type="text/javascript">
    ...
    var etSubmitData = {
        ...
        'everflow_offer_id': '',
        'offer_id': 'dm-offers',
        'external_customer_id': 'cid-68e274b73dfd93c6b1e1a904a109263a',
        'source_id': '',
        'everflow_uid': '',
        'page': 'WeightLossAdvocates-14',
        'ip_address': '34.46.237.233',
    ...
    if (previousId == "") {
        ...
        EF.click({
            ...
            Adv1: 'cid-68e274b73dfd93c6b1e1a904a109263a',
...
<script>
    ...
    document.getElementById('closeWarning').addEventListener('click',function(){
        ...
        let goalWeight = document.querySelector('[name="intake_goal_weight"]');
        removePulse(goalWeight);
        if (goalWeight.value != "") {
            return true;
        }
        addPulse(goalWeight);
...
<script>
    ...
    smartlook('identify', 'cid-68e274b73dfd93c6b1e1a904a109263a', {
        "offer": "dm-offers",
        "click_id": "",
        "affiliate": "",
        "sub_affiliate": "",
