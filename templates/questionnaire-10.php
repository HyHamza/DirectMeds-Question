...
<script>
    ...
    _paq.push(["setDomains", ["*.theweightlossadvocates.com","*.app.theweightlossadvocates.com"]]);
                _paq.push(['setCustomDimension', 4, 'cid-68e274b66e39a4e46ab110c7ff806475']);    _paq.push(["enableCrossDomainLinking"]);
    ...
    _paq.push(['enableLinkTracking']);
        ...
        window.dataLayer.push({
            ...
            'customer_id': 'cid-68e274b66e39a4e46ab110c7ff806475',
            'last_touch_channel': '',
            'offer_slug': 'dm-offers',
            'page': 'WeightLossAdvocates-10'
        });
        </script>
...
<body>
  <form id="WeightLossAdvocatesForm" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" >
    ...
    <div class="card-body survey-question">
        <h1>Are you either a diabetic on Insulin or have a history of diabetic retinopathy?</h1>
        <p>Any of these complications may disqualify you from weight loss medication approval. </p>
        <br>
        <div class="radioselection2 row">
            <input type="radio" name="intake_diabetic" id="intake_diabeticyes" value="yes" onclick="triggerBadResponseMessage()" >
            <label for="intake_diabeticyes" class="col">
                Yes
            </label>

            <input type="radio" name="intake_diabetic" id="intake_diabeticno" value="no" onclick="nextStep()" >
            <label for="intake_diabeticno" class="col">
                No
            </label>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var etSubmitData = {
        ...
        'everflow_offer_id': '',
        'offer_id': 'dm-offers',
        'external_customer_id': 'cid-68e274b66e39a4e46ab110c7ff806475',
        'source_id': '',
        'everflow_uid': '',
        'page': 'WeightLossAdvocates-10',
        'ip_address': '34.46.237.233',
    ...
    if (previousId == "") {
        ...
        EF.click({
            ...
            Adv1: 'cid-68e274b66e39a4e46ab110c7ff806475',
...
<script>
    ...
    document.getElementById('closeWarning').addEventListener('click',function(){
        ...
        return handleYesNo('intake_diabetic');
    }</script>
...
<script>
    ...
    smartlook('identify', 'cid-68e274b66e39a4e46ab110c7ff806475', {
        "offer": "dm-offers",
        "click_id": "",
        "affiliate": "",
        "sub_affiliate": "",
