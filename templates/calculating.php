...
<script>
    ...
    _paq.push(["setDomains", ["*.direct-meds.com","*.app.direct-meds.com"]]);
                _paq.push(['setCustomDimension', 4, 'cid-68e274b77a3e60a0900232d055b28be1']);    _paq.push(["enableCrossDomainLinking"]);
...
<noscript><p><img referrerpolicy="no-referrer-when-downgrade" src="https://directmeds.matomo.cloud/matomo.php?idsite=1&amp;rec=1" style="border:0;" alt="" /></p></noscript><!-- Google Tag Manager -->
        ...
        window.dataLayer.push({
            ...
            'customer_id': 'cid-68e274b77a3e60a0900232d055b28be1',
            'last_touch_channel': '',
...
<!-- End Google Tag Manager (noscript) --><form id="questionnaireForm" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" >
    ...
    <input type="hidden" name="page_slug" value="calculating">
    <input type="hidden" name="external_customer_id" value="cid-68e274b77a3e60a0900232d055b28be1"><input type="hidden" name="domain" value="directmeds.com"><input type="hidden" name="offer_slug" value="dm-offers"><input type="hidden" name="external_created_at" value="1759671479">    <input type="hidden" name="csrf_token" value="d8251b5bac188441f1377c541031eaf47a6f658223f8da2f133046e6904adef8af25d89e15" />
        ...
        <section class="container intersticial">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <center><h1>Calculating your results...</h1></center>
                    <br><br>
                    <span id="working">Analyzing...</span>
                    <div class="progress" id="progressResults">
                        <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 0%;"></div>
                    </div>

                    <div id="calculatingalert" style="display:none;">
                        <h4 style="font-weight:300;text-align:center;" class="textalt3">Progress Complete. We have evaluated your qualifications to see if you are a good fit for medically supervised GLP-1 Medications. </h4>

                        <div class="spacer">&nbsp;</div>
                        <div class="spacer">&nbsp;</div>
                        <center>
                            <a href="results.php"><button class="btn btn-lg ctaBtn1 submitbutton" type="button">
                                See Results
                            </button></a>
                        </center>
                    </div>
...
<script type="text/javascript">
    ...
    var etSubmitData = {
        ...
        'everflow_offer_id': '',
        'offer_id': 'dm-offers',
        'external_customer_id': 'cid-68e274b77a3e60a0900232d055b28be1',
        'source_id': '',
        'everflow_uid': '',
        'page': 'calculating',
        'ip_address': '34.46.237.233',
    ...
    if (previousId == "") {
        ...
        EF.click({
            ...
            Adv1: 'cid-68e274b77a3e60a0900232d055b28be1',
...
<script>
    ...
    function triggerProgressResults() {
    var progress = $('#progressResults');
    var progressBar = $('#progressResults .progress-bar');
    var alert = $('#calculatingalert');
    var working = $('#working');
...
<script>
    ...
    smartlook('identify', 'cid-68e274b77a3e60a0900232d055b28be1', {
        "offer": "dm-offers",
        "click_id": "",
        "affiliate": "",
        "sub_affiliate": "",
