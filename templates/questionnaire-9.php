...
<!-- End Google Tag Manager (noscript) --><form id="WeightLossAdvocatesForm" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" >
    ...
    <div class="card-body survey-question">
        <h1>Do you or an immediate family member have a history of medullary thyroid cancer?</h1>
        <p>Any of these complications may disqualify you from weight loss medication approval. </p>
        <br>
        <div class="radioselection2 row">
            <input type="radio" name="intake_thyroid" id="intake_thyroidyes" value="yes" onclick="triggerBadResponseMessage()" >
            <label for="intake_thyroidyes" class="col">
                Yes
            </label>

            <input type="radio" name="intake_thyroid" id="intake_thyroidno" value="no" onclick="nextStep()" >
            <label for="intake_thyroidno" class="col">
                No
            </label>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    if (previousId == "") {
        ...
        EF.click({
            ...
            Adv1: 'cid-68e274b6401e423fda008c6769f03318',
...
<script>
    ...
    document.getElementById('closeWarning').addEventListener('click',function(){
        ...
        return handleYesNo('intake_thyroid');
    }</script>
...
<script>
    ...
    smartlook('identify', 'cid-68e274b6401e423fda008c6769f03318', {
        "offer": "dm-offers",
        "click_id": "",
        "affiliate": "",
        "sub_affiliate": "",
