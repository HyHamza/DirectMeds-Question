        ...
        <section class="container intersticial">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <center>Direct Meds Doctors are available now to review your info.</center>
...
<div class="row">
    <div class="col-sm-4">
        <img src="../assets/images/t1.jpg" class="img-fluid" alt="Direct Meds Reviews"
             style="filter: drop-shadow(0.35rem 0.35rem 0.4rem rgba(0, 0, 0, 0.5));"> <br><br>
    </div>
    <div class="col-sm-4">
        <img src="../assets/images/t2.jpg" class="img-fluid" alt="Direct Meds Reviews"
             style="filter: drop-shadow(0.35rem 0.35rem 0.4rem rgba(0, 0, 0, 0.5));"> <br><br>
    </div>
    <div class="col-sm-4">
        <img src="../assets/images/t3.jpg" class="img-fluid" alt="Direct Meds Reviews"
             style="filter: drop-shadow(0.35rem 0.35rem 0.4rem rgba(0, 0, 0, 0.5));"> <br><br>
    </div>
</div>
