...
<script>
    ...
    _paq.push(["setDomains", ["*.theweightlossadvocates.com","*.app.theweightlossadvocates.com"]]);
                _paq.push(['setCustomDimension', 4, 'cid-68e274b53f3255157c9e227b49591ef5']);    _paq.push(["enableCrossDomainLinking"]);
    ...
    _paq.push(['enableLinkTracking']);
        ...
        window.dataLayer.push({
            ...
            'customer_id': 'cid-68e274b53f3255157c9e227b49591ef5',
            'last_touch_channel': '',
            'offer_slug': 'dm-offers',
            'page': 'WeightLossAdvocates-4'
        });
        </script>
        ...
        <section class="container intersticial">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <h1 style="text-align-center">GLP-1 meds are popular because they work!</h1>
                    <h4 style="font-weight:300;" class="textalt3">In clinical trials, semaglutide users lost a total of
                        10.9% of their
                        body weight in a 6 month period*</h4><br>
                    <img src="../assets/images/graph.png" class="img-fluid">
                    <br><br>
                    <i class="bi bi-circle-fill pink"></i> With GLP-1 Medications
                    <br>
                    <i class="bi bi-circle-fill blue"></i> Without GLP-1 Medications
                    <br><br>


                    <div class="spacer">&nbsp;</div>
                    <center>Weight Loss Advocates Doctors are available now to review your info.</center>

                    <div class="spacer">&nbsp;</div>
                    <div class="row g-3 justify-content-center">
                        <button type="button" class="btn btn-lg ctaBtn1" onclick="nextStep(event)">
                            Continue
                        </button>
                    </div>
                    <div class="spacer">&nbsp;</div>
...
<br><br>
<h2>Customer Before/After Photos:</h2><br>
<div class="row">
    <div class="col-sm-4">
        <img src="../assets/images/t1.jpg" class="img-fluid" alt="Weight Loss Advocates Reviews"
             style="filter: drop-shadow(0.35rem 0.35rem 0.4rem rgba(0, 0, 0, 0.5));"> <br><br>
    </div>
    <div class="col-sm-4">
        <img src="../assets/images/t2.jpg" class="img-fluid" alt="Weight Loss Advocates Reviews"
             style="filter: drop-shadow(0.35rem 0.35rem 0.4rem rgba(0, 0, 0, 0.5));"> <br><br>
    </div>
    <div class="col-sm-4">
        <img src="../assets/images/t3.jpg" class="img-fluid" alt="Weight Loss Advocates Reviews"
             style="filter: drop-shadow(0.35rem 0.35rem 0.4rem rgba(0, 0, 0, 0.5));"> <br><br>
    </div>
</div>
...
<script type="text/javascript">
    ...
    var etSubmitData = {
        ...
        'everflow_offer_id': '',
        'offer_id': 'dm-offers',
        'external_customer_id': 'cid-68e274b53f3255157c9e227b49591ef5',
        'source_id': '',
        'everflow_uid': '',
        'page': 'WeightLossAdvocates-4',
        'ip_address': '34.46.237.233',
    ...
    if (previousId == "") {
        ...
        EF.click({
            ...
            Adv1: 'cid-68e274b53f3255157c9e227b49591ef5',
...
<script>
    ...
    smartlook('identify', 'cid-68e274b53f3255157c9e227b49591ef5', {
        "offer": "dm-offers",
        "click_id": "",
        "affiliate": "",
        "sub_affiliate": "",
