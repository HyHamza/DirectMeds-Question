...
<script>
    ...
    _paq.push(["setDomains", ["*.theweightlossadvocates.com","*.app.theweightlossadvocates.com"]]);
                _paq.push(['setCustomDimension', 4, 'cid-68e274b70c27c5e01a82fda0a1d0fb9b']);    _paq.push(["enableCrossDomainLinking"]);
    ...
    _paq.push(['enableLinkTracking']);
        ...
        window.dataLayer.push({
            ...
            'customer_id': 'cid-68e274b70c27c5e01a82fda0a1d0fb9b',
            'last_touch_channel': '',
            'offer_slug': 'dm-offers',
            'page': 'WeightLossAdvocates-13'
        });
        </script>
...
<body>
  <form id="WeightLossAdvocatesForm" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" >
    ...
    <div class="card-body survey-question">
        <h1>Do you or have you had a history of GI disorders such as inflammatory bowel disease?</h1>
        <p>Any of these complications may disqualify you from weight loss medication approval. </p>
        <br>
        <div class="radioselection2 row">
            <input type="radio" name="intake_gi" id="intake_giyes" value="yes" onclick="triggerBadResponseMessage()" >
            <label for="intake_giyes" class="col">
                Yes
            </label>

            <input type="radio" name="intake_gi" id="intake_gino" value="no" onclick="nextStep()" >
            <label for="intake_gino" class="col">
                No
            </label>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var etSubmitData = {
        ...
        'everflow_offer_id': '',
        'offer_id': 'dm-offers',
        'external_customer_id': 'cid-68e274b70c27c5e01a82fda0a1d0fb9b',
        'source_id': '',
        'everflow_uid': '',
        'page': 'WeightLossAdvocates-13',
        'ip_address': '34.46.237.233',
    ...
    if (previousId == "") {
        ...
        EF.click({
            ...
            Adv1: 'cid-68e274b70c27c5e01a82fda0a1d0fb9b',
...
<script>
    ...
    smartlook('identify', 'cid-68e274b70c27c5e01a82fda0a1d0fb9b', {
        "offer": "dm-offers",
        "click_id": "",
        "affiliate": "",
        "sub_affiliate": "",
