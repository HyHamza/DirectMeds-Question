...
<script>
    ...
    _paq.push(["setDomains", ["*.theweightlossadvocates.com","*.app.theweightlossadvocates.com"]]);
                _paq.push(['setCustomDimension', 4, 'cid-68e274b60fdb9aaf8c647f2aaaa7f0ad']);    _paq.push(["enableCrossDomainLinking"]);
    ...
    _paq.push(['enableLinkTracking']);
        ...
        window.dataLayer.push({
            ...
            'customer_id': 'cid-68e274b60fdb9aaf8c647f2aaaa7f0ad',
            'last_touch_channel': '',
            'offer_slug': 'dm-offers',
            'page': 'WeightLossAdvocates-8'
        });
        </script>
...
<body>
  <form id="WeightLossAdvocatesForm" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" >
        ...
        <section class="container intersticial">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <center><h1>We specialize in weight loss with GLP-1 medications.</h1></center>
                    <br>
                    <img src="../assets/images/products-mobi-2.png" class="img-fluid">

                    <div class="squares">
                        <ul class="textalt3">
                            <li>All telemed doctors are licensed and insured.</li>
                            <li>Upon prescription approval, your medication will ship within 1 business day.</li>
                            <li>Medications are shipped via temperature-controlled UPS rush overnight delivery.</li>
                            <li>All shipments are insured and tracked to your door.</li>
                        </ul>
    ...
    <button type="button" class="btn btn-lg ctaBtn1" onclick="nextStep()">Continue</button>
                        ...
                        <div class="borderbox">
                            <center>
                                <p style="font-size:18px;">There are currently <strong><u style="text-decoration-color: #F817FD;font-size:21px;">2</u></strong> telemed doctor consultations available today.<br/><span style="color:#c8cdfa;font-size:12px;">(100% included with your purchase)</span></p>
                            </center>
                        </div>
                        <div class="spacer">&nbsp;</div>
                        <h1>
                            <center>Your expected delivery date: <u style="text-decoration-color: #F817FD;"><span>Wednesday, October 8</span></u></center>
                        </h1><br>
                    ...
                    <p class="fineprint">* Based on the average weight loss in three 68-week clinical trials of patients
                        without diabetes who reached and maintained a dose of 2.4 mg/week of GLP-1 treatment, along with
                        a reduced-calorie diet and increased physical activity. Results may vary based on starting
                        weight and program adherence. Medication prescriptions are at the discretion of medical
                        providers and may not be suitable for everyone. Consult a healthcare professional before
                        starting any weight loss program.</p>
                    <div class="spacer">&nbsp;</div>
                    <div class="spacer">&nbsp;</div>
                    <div class="row g-3 justify-content-center">
                        <button type="button" class="btn btn-lg ctaBtn1" onclick="nextStep()">Continue</button>
...
<script type="text/javascript">
    ...
    var etSubmitData = {
        ...
        'everflow_offer_id': '',
        'offer_id': 'dm-offers',
        'external_customer_id': 'cid-68e274b60fdb9aaf8c647f2aaaa7f0ad',
        'source_id': '',
        'everflow_uid': '',
        'page': 'WeightLossAdvocates-8',
        'ip_address': '34.46.237.233',
    ...
    if (previousId == "") {
        ...
        EF.click({
            ...
            Adv1: 'cid-68e274b60fdb9aaf8c647f2aaaa7f0ad',
...
<script>
    ...
    smartlook('identify', 'cid-68e274b60fdb9aaf8c647f2aaaa7f0ad', {
        "offer": "dm-offers",
        "click_id": "",
        "affiliate": "",
        "sub_affiliate": "",
