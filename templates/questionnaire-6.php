...
<script>
    ...
    _paq.push(["setDomains", ["*.theweightlossadvocates.com","*.app.theweightlossadvocates.com"]]);
                _paq.push(['setCustomDimension', 4, 'cid-68e274b59f290b6201477d6afc1a6edb']);    _paq.push(["enableCrossDomainLinking"]);
    ...
    _paq.push(['enableLinkTracking']);
        ...
        window.dataLayer.push({
            ...
            'customer_id': 'cid-68e274b59f290b6201477d6afc1a6edb',
            'last_touch_channel': '',
            'offer_slug': 'dm-offers',
            'page': 'WeightLossAdvocates-6'
        });
        </script>
...
<body>
  <form id="WeightLossAdvocatesForm" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" >
    ...
    <div class="card-body">
        ...
        <p>Your height and weight affect your BMI. Please confirm your height and weight to proceed.  </p>
        <br>
...
<script type="text/javascript">
    ...
    var etSubmitData = {
        ...
        'everflow_offer_id': '',
        'offer_id': 'dm-offers',
        'external_customer_id': 'cid-68e274b59f290b6201477d6afc1a6edb',
        'source_id': '',
        'everflow_uid': '',
        'page': 'WeightLossAdvocates-6',
        'ip_address': '34.46.237.233',
    ...
    if (previousId == "") {
        ...
        EF.click({
            ...
            Adv1: 'cid-68e274b59f290b6201477d6afc1a6edb',
...
<script>
    ...
    function triggerBadBmi() {
        let bmiCorrection = document.getElementById('bmiCorrection');
        bmiCorrection.style.display = 'block';
    }

    function calcBmi(inches,weight) {
...
<script>
    ...
    smartlook('identify', 'cid-68e274b59f290b6201477d6afc1a6edb', {
        "offer": "dm-offers",
        "click_id": "",
        "affiliate": "",
        "sub_affiliate": "",
