...
<script>
    ...
    _paq.push(["setDomains", ["*.theweightlossadvocates.com","*.app.theweightlossadvocates.com"]]);
                _paq.push(['setCustomDimension', 4, 'cid-68e27438de326a35b783ff8f6fc5fcf8']);    _paq.push(["enableCrossDomainLinking"]);
...
<body>
  <form id="WeightLossAdvocatesForm" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" >
    ...
    <div class="card-body">
        ...
        <p>Your age plays a significant role in your metabolism. Knowing your age helps us understand your body's needs better.  </p>
        <br>
        <div class="row g-3 justify-content-center">
            <div class="col-auto">
                <select name="intake_dob_month" class="select form-control form-control-lg">
                    <option disabled selected value="">Month</option><option value='1' >January</option><option value='2' >February</option><option value='3' >March</option><option value='4' >April</option><option value='5' >May</option><option value='6' >June</option><option value='7' >July</option><option value='8' >August</option><option value='9' >September</option><option value='10' >October</option><option value='11' >November</option><option value='12' >December</option>
                </select>
            </div>

            <div class="col-auto">
                <select name="intake_dob_day" class="select form-control form-control-lg">
                    <option disabled selected value="">Day</option><option value='1' >1</option><option value='2' >2</option><option value='3' >3</option><option value='4' >4</option><option value='5' >5</option><option value='6' >6</option><option value='7' >7</option><option value='8' >8</option><option value='9' >9</option><option value='10' >10</option><option value='11' >11</option><option value='12' >12</option><option value='13' >13</option><option value='14' >14</option><option value='15' >15</option><option value='16' >16</option><option value='17' >17</option><option value='18' >18</option><option value='19' >19</option><option value='20' >20</option><option value='21' >21</option><option value='22' >22</option><option value='23' >23</option><option value='24' >24</option><option value='25' >25</option><option value='26' >26</option><option value='27' >27</option><option value='28' >28</option><option value='29' >29</option><option value='30' >30</option><option value='31' >31</option>
                </select>
            </div>

            <div class="col-auto">
                <select name="intake_dob_year" class="select form-control form-control-lg">
                    <option disabled selected value="">Year</option><option value='2007' >2007</option><option value='2006' >2006</option><option value='2005' >2005</option><option value='2004' >2004</option><option value='2003' >2003</option><option value='2002' >2002</option><option value='2001' >2001</option><option value='2000' >2000</option><option value='1999' >1999</option><option value='1998' >1998</option><option value='1997' >1997</option><option value='1996' >1996</option><option value='1995' >1995</option><option value='1994' >1994</option><option value='1993' >1993</option><option value='1992' >1992</option><option value='1991' >1991</option><option value='1990' >1990</option><option value='1989' >1989</option><option value='1988' >1988</option><option value='1987' >1987</option><option value='1986' >1986</option><option value='1985' >1985</option><option value='1984' >1984</option><option value='1983' >1983</option><option value='1982' >1982</option><option value='1981' >1981</option><option value='1980' >1980</option><option value='1979' >1979</option><option value='1978' >1978</option><option value='1977' >1977</option><option value='1976' >1976</option><option value='1975' >1975</option><option value='1974' >1974</option><option value='1973' >1973</option><option value='1972' >1972</option><option value='1971' >1971</option><option value='1970' >1970</option><option value='1969' >1969</option><option value='1968' >1968</option><option value='1967' >1967</option><option value='1966' >1966</option><option value='1965' >1965</option><option value='1964' >1964</option><option value='1963' >1963</option><option value='1962' >1962</option><option value='1961' >1961</option><option value='1960' >1960</option><option value='1959' >1959</option><option value='1958' >1958</option><option value='1957' >1957</option><option value='1956' >1956</option><option value='1955' >1955</option><option value='1954' >1954</option><option value='1953' >1953</option><option value='1952' >1952</option><option value='1951' >1951</option><option value='1950' >1950</option><option value='1949' >1949</option><option value='1948' >1948</option><option value='1947' >1947</option><option value='1946' >1946</option><option value='1945' >1945</option><option value='1944' >1944</option><option value='1943' >1943</option><option value='1942' >1942</option><option value='1941' >1941</option><option value='1940' >1940</option><option value='1939' >1939</option><option value='1938' >1938</option><option value='1937' >1937</option><option value='1936' >1936</option><option value='1935' >1935</option><option value='1934' >1934</option><option value='1933' >1933</option><option value='1932' >1932</option><option value='1931' >1931</option><option value='1930' >1930</option><option value='1929' >1929</option><option value='1928' >1928</option><option value='1927' >1927</option><option value='1926' >1926</option><option value='1925' >1925</option>
                </select>
            </div>
            <div class="spacer"></div>
            <button type="button" class="btn btn-lg ctaBtn1" onclick="nextStep(event)">Next</button>
            <div class="spacer"></div>
        </div>
    </div>
</div>            </div>
...
<script type="text/javascript">
    ...
    var etSubmitData = {
        ...
        'everflow_offer_id': '',
        'offer_id': 'dm-offers',
        'external_customer_id': 'cid-68e27438de326a35b783ff8f6fc5fcf8',
        'source_id': '',
        'everflow_uid': '',
    ...
    if (previousId == "") {
        ...
        EF.click({
            ...
            Adv1: 'cid-68e27438de326a35b783ff8f6fc5fcf8',
...
<script>
    ...
    document.getElementById('closeWarning').addEventListener('click',function(){
        ...
        let month = document.querySelector('[name="intake_dob_month"]');
        let day = document.querySelector('[name="intake_dob_day"]');
        let year = document.querySelector('[name="intake_dob_year"]');
        let elements = [month,day,year];
        removePulse(elements);
        var passed = true;
        elements.forEach((el) => {
            if (el.value == "") {
    ...
    function populateDays() {
        const daySelect = document.querySelector('[name="intake_dob_day"]');
        const month = document.querySelector('[name="intake_dob_month"]').value;
        const year = document.querySelector('[name="intake_dob_year"]').value;
        const daysInMonth = new Date(year != "" ? year : ((new Date().getFullYear()) - 18), month != "" ? month : 1, 0).getDate();
        ...
        if (selectedDay != "" && selectedDay <= daysInMonth) {
            document.querySelector('[name="intake_dob_day"] option[value="'+selectedDay+'"]').selected = true;
        }
    }

    document.querySelectorAll('[name="intake_dob_month"],[name="intake_dob_year"]').forEach((el) => {el.addEventListener('change', function () {
        populateDays();
    })});</script>
...
<script>
  ...
  <div class="footer"><center><a href="/terms">Terms & Conditions</a> | <a href="/privacy">Privacy Policy</a> | <a href="/terms#refunds">Refund Policy</a> | <a href="https://Weight Loss Advocates.everflowclient.io/affiliate/signup" target="_blank" rel="nofollow">Affiliates</a> | <a href="/contact">Contact Us</a> <br><br>Weight Loss Advocates, LLC</center></div><br><br><br><script>
...
<script>
    ...
    smartlook('identify', 'cid-68e27438de326a35b783ff8f6fc5fcf8', {
        "offer": "dm-offers",
        "click_id": "",
        "affiliate": "",
        "sub_affiliate": "",
